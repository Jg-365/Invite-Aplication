...
function BirthdayInvitation() {
  ...
  if (guest.name === "Will e Lucimar" || guest.name === "Igor e Fátima") {
    return (
        ...
        <div className="container">
          ...
          {step === 0 && guest && (
            <>
              ...
              <p>
                Que tal um churrasquinho com pagode de mexer com o coração e com
                o fígado? Venham aproveitar o meu aniversário de 21 comigo pô,
                vai ser massa!
              </p>
        ...
        <div className="container">
          ...
          {step === 0 && guest && (
            <>
              ...
              <p>
                Que tal um churrasquinho com pagode de mexer com o coração e com
                o fígado? Vem aproveitar o meu aniversário de 21 comigo pô, vai
                ser massa!
              </p>
              <p style={{ fontWeight: "bold" }}>
                Data: Sábado, 19 de Outubro <br />
